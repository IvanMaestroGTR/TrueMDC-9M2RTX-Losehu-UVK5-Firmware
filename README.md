...
- Call End Tone (C.End): optional FM call-end tone after the dual-watch inactivity delay, with red and green LEDs combined as a yellow indicator while pending
- Talk Permit Tone (TPT): selectable XTS, TRBO, and HYT talk-permit tones after pre-ID signaling, with local audio and a blank RF signal
